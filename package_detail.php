...
<?php 
    ...
    if (isset($_GET['id'])) {
        ...
        if (!$category) {
            ...
            // Handle the case where the 'id' parameter is missing in the URL
    ...
    if (isset($_POST['register'])) {
        ...
        $user_firstname = my_ob_clean($_POST['user_firstname']);
        $user_lastname  = my_ob_clean($_POST['user_lastname']);
        $user_email     = my_ob_clean($_POST['user_email']);
        $user_password  = my_ob_clean($_POST['user_password']);
        $wedding_date   = my_ob_clean($_POST['wedding_date']);
        $user_phone     = my_ob_clean($_POST['user_phone']);
        $bid = my_ob_clean($_POST['booking_id']);

...
<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        $fullname = my_ob_clean($_POST['fullname']);
        $guestname =my_ob_clean($_POST['guestname']);
        $address = my_ob_clean($_POST['address']);
        $city = my_ob_clean($_POST['city']);
        $state = my_ob_clean($_POST['state']);
        $zipcode = my_ob_clean($_POST['zipcode']);
        $priority = my_ob_clean($_POST['priority']);
        $out_of_town = my_ob_clean($_POST['out_of_town']);
        $relationship = my_ob_clean($_POST['relationship']);
        $gifts = my_ob_clean($_POST['gifts']);

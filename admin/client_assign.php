...
$bride = isset($_POST['bride']) ? trim($_POST['bride']) : '';
$groom = isset($_POST['groom']) ? trim($_POST['groom']) : '';
$phone = isset($_POST['phone']) ? trim($_POST['phone']) : '';
$city = isset($_POST['city']) ? trim($_POST['city']) : '';
$wedding_type = isset($_POST['wedding_type']) ? trim($_POST['wedding_type']) : '';
$organizer_id = isset($_POST['organizer_id']) ? trim($_POST['organizer_id']) : '';
$description = isset($_POST['description']) ? trim($_POST['description']) : '';
$location = isset($_POST['location']) ? trim($_POST['location']) : '';
$expectation_visitor = isset($_POST['expectation_visitor']) ? trim($_POST['expectation_visitor']) : '';
$cash_advanced = isset($_POST['cash_advanced']) ? trim($_POST['cash_advanced']) : '';

...
<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($booking_detail) {
            ...
            $firstname = my_ob_clean($_POST['firstname']);
            $lastname = my_ob_clean($_POST['lastname']);
            $email = my_ob_clean($_POST['email']);
            $wedding_date = my_ob_clean($_POST['wedding_date']);
            $bride = my_ob_clean($_POST['bride']);
            $groom = my_ob_clean($_POST['groom']);
            $phone = my_ob_clean($_POST['phone']);
            $city = my_ob_clean($_POST['city']);
            $wedding_type = my_ob_clean($_POST['wedding_type']);
            $organizer_id = my_ob_clean($_POST['organizer_id']);

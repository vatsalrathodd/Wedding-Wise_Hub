...
<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        $username    = my_ob_clean($_POST['username']);
        $password    = my_ob_clean($_POST['password']);
        $password2   = my_ob_clean($_POST['password2']);
        $gender      = my_ob_clean($_POST['gender']);
        $designation = my_ob_clean($_POST['designation']);

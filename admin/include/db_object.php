...
class DB_Object
{
    ...
    public function update_user_account() {
        global $db;
        $properties = $this->ob_clean_properties();
    ...
    protected function ob_clean_properties() {
        global $db;
        $ob_clean_properties = array();
        foreach ($this->properties() as $key => $value) {
            $ob_clean_properties[$key] = $db->escape_string($value);
        }
        return $ob_clean_properties;
    }

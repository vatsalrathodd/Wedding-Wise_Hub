...
define('SITE_ROOT', $webroot . 'Wedding-Management-PHP'); // Adjust this to your project's root folder
define('INCLUDES_PATH', SITE_ROOT . DS . 'admin' . DS . 'include');

// require_once(INCLUDES_PATH.DS."");
